...
Skills are reusable workflow templates that can be invoked via `/skill-name`. Each skill provides:
...
| `learn-about-omd/SKILL.md` | learn-about-omd | Usage pattern analysis |
...
model: medium  # Optional: tier override (light|medium|heavy|inherit)
---
...
- Test skill invocation with `/skill-name`
