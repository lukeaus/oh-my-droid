# AI Instructions for oh-my-droid

This file provides context for AI when working on this repository via GitHub Actions.

## Repository Overview

oh-my-droid is a Factory Droid plugin that provides multi-agent orchestration capabilities.
...
### Bug Reports
- Ask for Factory Droid version if not provided
