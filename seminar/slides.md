...
---
# oh-my-droid: Multi-Agent Orchestration for Factory Droid
...
**A multi-agent orchestration system for Factory Droid**
...
Note: The model parameter is always passed explicitly - Factory Droid doesn't auto-apply model from agent definitions.
...
Note: The HUD integrates with Factory Droid's statusLine API to show real-time orchestration state.
...
**Project-level:** `FACTORY.md` in project root
**Global:** `~/.factory/FACTORY.md`
...
**GitHub Repository**
```
github.com/MeroZemory/oh-my-droid
```
...
| learn-about-omd | Usage analysis | `/learn-about-omd` |
