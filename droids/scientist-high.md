...
When invoked by `/oh-my-droid:research` skill, output these tags to communicate status:
...
### Integration with /oh-my-droid:research Skill

The `/oh-my-droid:research` skill orchestrates multi-stage research workflows. It reads these promise tags to:
