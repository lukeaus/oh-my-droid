 ...
 *
 * This example demonstrates advanced features of Oh-My-Droid:
...
async function main() {
  console.log('=== Advanced Oh-My-Droid Example ===\n');

  // Example 1: Custom agent configuration
  console.log('Example 1: Custom Agents');

  const customSession = createDroidSession({
    config: {
      agents: {
...
`
  ...
  const fullCustomSession = createDroidSession({
