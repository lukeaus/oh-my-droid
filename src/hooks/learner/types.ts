...
export interface LearnedSkill {
  ...
  relativePath: string;
  /** Whether from user dir (~/.agents/skills/droid-learned, with legacy ~/.factory/skills/droid-learned and ~/.omd/skills fallback) or project (.agents/skills/droid-learned, with legacy .omd/skills) */
  scope: 'user' | 'project';
