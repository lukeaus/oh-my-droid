...
describe('tmux-detector', () => {
  ...
  describe('analyzePaneContent', () => {
    it('should detect rate limit messages with Factory Droid context', () => {
      const content = `
    ...
    it('should not flag content without Factory Droid indicators', () => {
      const content = `
        vim test.js
        Hello World
      `;
  ...
  describe('formatBlockedPanesSummary', () => {
    it('should format empty list', () => {
      ...
      expect(result).toBe('No blocked Factory Droid sessions detected.');
    });
